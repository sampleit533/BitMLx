...
def gen_stats(dpath, flist):
    ...
    for fname in flist:
        ...
        # Depth files are produced by the BitMLx compiler as *_depth.txt.
        # Avoid treating unrelated text files (e.g. a saved statistics.txt) as depth.
        if fname.endswith("_depth.txt"):
